...
@inline _valueset_elsize(s::CartesianPower) = pwr_size(s)
@inline _valueset_elsize(s) = NoMSpaceElementSize{typeof(s)}()

@inline _valueset_flatsize(s::CartesianPower) = _cat_sizes(_valueset_flatsize(pwr_base(s)), pwr_size(s))
@inline _valueset_flatsize(s) = _valueset_elsize(s)
