...
@testset "StandardDist{Uniform}" begin
    ...
    @testset "StandardDist{Uniform,0}" begin
        ...
        @test @inferred(product_distribution(fill(StandardDist{Uniform}(), 3))) isa MeasureBaseDistributionsExt.StandardDist{Uniform,1}
        @test product_distribution(fill(StandardDist{Uniform}(), 3)) == MeasureBaseDistributionsExt.StandardDist{Uniform}(3)
    end


    @testset "StandardDist{Uniform,1}" begin
        d = MeasureBaseDistributionsExt.StandardDist{Uniform}(3)
